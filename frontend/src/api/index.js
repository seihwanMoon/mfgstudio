...
export const opsAPI = {
  ...
  cleanupDeletePreview: (experimentId) => api.get(`/api/ops/experiments/${experimentId}/cleanup-delete-preview`),
  cleanupDeleteExperiment: (experimentId) => api.post(`/api/ops/experiments/${experimentId}/cleanup-delete`),
  mlflowOrphans: () => api.get("/api/ops/mlflow-orphans"),
  deleteMlflowExperiment: (experimentId) => api.delete(`/api/ops/mlflow-experiments/${experimentId}`),
  deleteMlflowModel: (modelName) => api.delete(`/api/ops/mlflow-models/${encodeURIComponent(modelName)}`),
